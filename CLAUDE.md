...
| Topic | Issues |
|---|---|
| **Open bugs** | #70 fields silently dropped · #71 `restart: on-failure:N` · #72 removed stack keeps containers · #73 pull after recreate decision · #74 one failure aborts stack · #75 `ExecOnContainer` false success · #76 agent env leaks into interpolation · #77 unset metrics · #50 permission matrix drops role |
